...
// Supabase Storage public bucket for product photos (project ivxvzyokijsatdlonpec, bucket IMAGE)
...
// Minimum de commande, en pièces. Repris dans la FAQ de /contact et dans les
// réponses automatiques des réseaux sociaux (lib/autoreply.js).
export const MIN_ORDER = 20

// Horaires d'ouverture. L'Algérie a son week-end vendredi/samedi : la semaine
// de travail va donc du dimanche au jeudi.
export const HOURS = [
