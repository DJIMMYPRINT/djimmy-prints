...
const CAS = [
  ...
  ['je veux un échantillon avant de commander', 'echantillon'],
  ...
  ['vous avez des photos de vos réalisations ?', 'echantillon'],
...
test('un terme métier précis bat une tournure générique', () => {
  ...
  assert.equal(matchRule('je veux un echantillon').rule.key, 'echantillon')
